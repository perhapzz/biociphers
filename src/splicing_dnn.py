...
from data_prep import read_input_data_splicing
...
def test_svm(svm_model, data, test_results):
    ...
    :param data: dict, data dictionary with the splicing data
    :param test_results: dict, data dictionary for saving test results
    :return: None
    """
    print("svm model")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--input_data_file',
        type=str,
        help="Input data for testing splicing DNN models"
    )
    ...
    data, feature_shape = read_input_data_splicing(input_data_file=args.input_data_file)
